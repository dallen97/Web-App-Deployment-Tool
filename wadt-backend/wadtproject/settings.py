...
MIDDLEWARE = [
    ...
    "django.contrib.sessions.middleware.SessionMiddleware",  # Uncommented this line
    "django.middleware.common.CommonMiddleware",
    "django.middleware.csrf.CsrfViewMiddleware",  # FIXME: Temporarily disabled for testing
