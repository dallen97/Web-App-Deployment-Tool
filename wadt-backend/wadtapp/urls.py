...
urlpatterns = [
    ...
    path('api/verify_mfa_login/', views.verify_mfa_login, name='verify_mfa_login'),
    path('api/setup_mfa/', views.setup_mfa, name='setup_mfa'),
    path('api/verify_mfa_setup/', views.verify_mfa_setup, name='verify_mfa_setup'),
